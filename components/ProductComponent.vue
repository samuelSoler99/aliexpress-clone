    ...
    <NuxtLink :to="`/item/${product.id}`">
      ...
      <div id="ProductDetails">
        <span class="flex items-center justify-start gap-3 px-1 pt-1">
          ...
          <span class="text-gray-500 text-sm text-light tine-through">${{ oldPriceComputed }}</span>
        </span>
        ...
        <p class="flex items-center px-1 pt-0.5 text-xs text-[#252525]">
          5,000+ sold <Icon name="material-symbols:star-rate" color="#757575" class="ml-1.5">4.7</Icon>
        </p>
